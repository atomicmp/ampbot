...
var texts = {
    ...
    NO_ACCOUNT: function (target) { return "No account found for " + target.displayName + "!"; },
    NO_TARGETS: function () { return "This command requires targets. Please mention a user."; },
    UNBANNED: function (target) { return target.displayName + " has been unbanned!"; },
};
function unbanUser(msg) {
    return __awaiter(this, void 0, void 0, function () {
        var author, member, targets;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4: return [4 /*yield*/, Promise.all(targets.map(function (target) { return __awaiter(_this, void 0, void 0, function () {
                        var targetHasAccount, _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    _a = lodash_isempty_1.default;
                                    return [4 /*yield*/, services_1.db("users").where("discord_id", target.id)];
                                case 1:
                                    targetHasAccount = !_a.apply(void 0, [_b.sent()]);
                                    if (!targetHasAccount) return [3 /*break*/, 4];
                                    return [4 /*yield*/, services_1.db("users").where("discord_id", target.id).update("role", 3)];
                                case 2:
                                    _b.sent();
                                    return [4 /*yield*/, msg.channel.send(texts.UNBANNED(target))];
                                case 3:
                                    _b.sent();
                                    return [3 /*break*/, 6];
                                case 4: return [4 /*yield*/, msg.channel.send(texts.NO_ACCOUNT(target))];
                                case 5:
                                    _b.sent();
                                    _b.label = 6;
